...
27. **Production data counts (as of 2026-05-31 CUTOVER; locations updated 2026-06-05):** 547 locations (510 RACK + 35 SHELF_BIN + 1 UNLISTED_TOTE + 1 SHIPPED — **migrations 0007–0008 2026-06-05**: 0007 converted rack-pattern shelf bins → RACK, deleted 1 malformed bin, renamed 9 spelled-out section-O names to compact; 0008 re-typed Section A's 20 mis-typed `AR##S##` bins UNLISTED_TOTE→RACK. The 35 SHELF_BIN are non-rack oddballs kept by design [BIN 01-26, FAN, ESECTA/B/C, RYR0001-4, CR03A02]; the lone UNLISTED_TOTE is `RETURN-1`), 3,390 items (all STORED; **intake_date backfilled 2026-05-31** from the extract's createdAt — was NULL at cutover), 3,390 moves (all import-baseline), 12 serial sequences (vestigial). Live-inventory-only baseline — shipped items were dropped at cutover (eBay/ShippingEasy own shipped now). If you see drastically different counts in a session, investigate before making changes — something may be wrong. *(Prior 2026-04-02 baseline 537/3,380/3,969 superseded by the cutover reload.)*
